...
const OffersPage = ({ search, results, destination, fallback, canonicalUrl }) => {
  ...
  const [filterValues, setFilterValues] = useState({
    destinations: [{ label: 'Kvarner', obj_type: 'region', value: '65' }],
  });
  ...
  return (
    <SWRConfig value={{ fallback }}>
      <Head>
        <title>{t('rental_meta_title_kvarner')}</title>
        <meta name="title" content={t('rental_meta_title_kvarner')} />
        <meta name="description" content={t('rental_meta_description')} />

        <meta property="og:type" content="website" />
        <meta property="og:url" content={canonicalUrl} />
        <meta property="og:title" content={t('rental_meta_title_kvarner')} />
        ...
        <meta property="twitter:title" content={t('rental_meta_title_kvarner')} />
...
export const getStaticProps = async ({ locale }) => {
  ...
  const search = '/najem-plovil?destinations=region-65-Kvarner';

  const { data } = await getSearchResultsFromApi(search);

  const najemPlovil = '/najem-plovil/kvarner';
