...
const OffersPage = ({ search, results, destination, fallback, canonicalUrl }) => {
  ...
  const [filterValues, setFilterValues] = useState({
    destinations: [{ label: 'Istra', obj_type: 'region', value: '58' }],
  });
  ...
  return (
    <SWRConfig value={{ fallback }}>
      <Head>
        <title>{t('rental_meta_title_istra')}</title>
        <meta name="title" content={t('rental_meta_title_istra')} />
        <meta name="description" content={t('rental_meta_description')} />

        <meta property="og:type" content="website" />
        <meta property="og:url" content={canonicalUrl} />
        <meta property="og:title" content={t('rental_meta_title_istra')} />
        ...
        <meta property="twitter:title" content={t('rental_meta_title_istra')} />
...
export const getStaticProps = async ({ locale }) => {
  ...
  const search = '/najem-plovil?destinations=region-58-Istra';

  const { data } = await getSearchResultsFromApi(search);

  const najemPlovil = '/najem-plovil/istra';
