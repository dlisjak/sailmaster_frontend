...
const PrivacySi = () => {
  ...
  return (
    <FilterSideWrapper location={router.pathname}>
      <Head>
        <title>
          Zaupnost podatkov - TheSailmaster.si | Najem jadrnice, katamarana, jahte - last minute
        </title>
        <meta
          name="description"
      ...
      <div className="contact">
        <Row>
          <Col xs={12} sm={12}>
            <div className="col-inner" dangerouslySetInnerHTML={{ __html: PAGE_HTML }}></div>
          </Col>
        </Row>
      </div>
    </FilterSideWrapper>
