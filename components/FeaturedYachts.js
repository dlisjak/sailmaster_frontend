    ...
    <div className="featured-yacht">
      <div>
        <h3 className="featured-yacht__name">
          <Link
            href={offerUrl(item.yacht_id, item.yacht_model_name, item.offer_id)}
          >
            {item.title}
          </Link>
        </h3>
    ...
    <div className="featured-yachts">
      <div className="row">
        {items
          ...
          .map((item) => (
            <div className="flex xl:w-1/4 pr-4 pl-4 md:w-1/3 pr-4 pl-4 sm:w-1/2 pr-4 pl-4" key={item.yacht_id}>
